...
const ERR_PY					= 'An error occured with the python script. Use `json.dump(your_data, open(sys.argv[2], \'w+\'))` to output them. Refer to the README.md for more informations.';
const ERR_PY_NO_STDERR			= 'An error occured with the python script, but it didn\'t print any errors.';
const ERR_PY_OUTPUT				= 'Your script didn\'t produce any output file. Use `json.dump(your_data, open(sys.argv[2], \'w+\'))` to output them. Refer to the README.md for more informations.';