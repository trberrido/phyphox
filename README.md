...
You can find some example of phyphox experiments HERE. If you want to test them on your server, do not forget to change the parameter `address` in the `connection` field.

## Python Scripting

If you enter a python script, it will be executed on the received data before plotting. Some example can be found HERE.
